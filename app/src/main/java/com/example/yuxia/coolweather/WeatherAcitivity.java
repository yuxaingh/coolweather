...
import com.example.yuxia.coolweather.gson.Forecast;
...
public class WeatherAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(weatherString != null){
            //Have cashe parse the weather data directly
            Weather weather  = Utility.handleWeatherResponse(weatherString);
            showWeatherInfo(weather);
        }else{
            //No Cache, use http to request weather info
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=5496bf7a7d6242aa81b471a1fdad033a";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(WeatherAcitivity.this, "Weather data request failed", Toast.LENGTH_SHORT).show();
                    }
                });
            }
